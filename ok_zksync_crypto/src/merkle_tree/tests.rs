...
fn test_verify_proof() {
    ...
    let mut tree = parallel_smt::SparseMerkleTree::<
        u64,
        Fr,
        RescueHasher<Engine>,
        DefaultMemorySMTStorage<u64>,
    >::new(depth);
...
fn big_test() {
    ...
    let root_hash: Fr = from_hex(&input.root_hash).unwrap();
