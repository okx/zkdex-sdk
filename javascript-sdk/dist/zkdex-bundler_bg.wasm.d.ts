...
export function sign_eth_address(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
...
export function unified_sign_spot_limit_order(a: number, b: number, c: number, d: number, e: number): void;
export function unified_hash_spot_limit_order(a: number, b: number, c: number): void;
export function unified_sign_perpetual_limit_order(a: number, b: number, c: number, d: number, e: number): void;
export function unified_hash_perpetual_limit_order(a: number, b: number, c: number): void;
