...
export function sign_withdraw(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function hash_withdraw(a: number, b: number, c: number, d: number, e: number): void;
...
export function Java_com_okx_ZKDEX_signWithdraw(a: number, b: number, c: number, d: number, e: number): number;
...
export function Java_com_okx_ZKDEX_hashWithdraw(a: number, b: number, c: number, d: number): number;
