...
public class ZKDEXTest {
   ...
   public void signLimitOrder() throws Exception {
    ...
    public void test_sign_spot_transfer() throws Exception {
        ...
        Signature signature = JSON.parseObject(sigStr, Signature.class);
        Signature expectSig = new Signature("0xa2512dc539db0007395a7a23296da9d464df820faf71c104b4f8914a67394ab5", "0x03109f8beb7379d9982f1860ea040c3dae4db30b1e20d2c699be11d90e4b8f20");
        assertEquals(expectSig, signature);
    ...
    public void test_sign_spot_withdrawal() throws Exception {
        ...
        Signature signature = JSON.parseObject(sigStr, Signature.class);
        Signature expectSig = new Signature("0xaf19578e4a6314d1c35e76d95f1c737c5e5972896ba5108a8c22e3c2ac811394", "0x0506f65a264f4aef49be00ec1c59338f90fffda5f74020f6afcad00e7a4becbe");
        assertEquals(expectSig, signature);
    ...
    public void test_sign_spot_limit_order() throws Exception {
        ...
        Signature signature = JSON.parseObject(sigStr, Signature.class);
        Signature expectSig = new Signature("0x0d5fb0c83cc302c9e6d51a5e4d5081c9405a146e079a27f41895ea7e7673f78f", "0x017e934ee485d0ea5af02719a8923ec1b94c60633dd87e8731673589e9311b98");
        assertEquals(expectSig, signature);
