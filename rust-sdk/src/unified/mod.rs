...
/// let sig = zkdex_sdk::unified::unified_sign_withdrawal(json, &private_key);
/// assert!(sig.is_ok());
/// ```
...
///         }
///         "#;
/// let hash = zkdex_sdk::unified::unified_hash_withdrawal(json);
/// assert!(hash.is_ok());
/// ```
...
/// Sign a spot trade transaction. The transaction includes two orders from party A and party B.
/// # Examples
/// ```
/// use zkdex_sdk::private_key_from_seed;
/// let json = r#"
...
///         }"#;
/// let private_key_a = private_key_from_seed("welcome to zkdex, this is a private key seed a".as_bytes()).unwrap();
/// let private_key_b = private_key_from_seed("welcome to zkdex, this is a private key seed b".as_bytes()).unwrap();
/// let sig = zkdex_sdk::unified::unified_sign_spot_trade(json, &private_key_a, &private_key_b);
/// assert!(sig.is_ok());
/// ```
...
///             "type": "UNIFIED_SPOT_TRADE"
///         }"#;
/// let hash = zkdex_sdk::unified::unified_hash_spot_trade(json);
/// assert!(hash.is_ok());
/// ```
...
/// let private_key_a = private_key_from_seed("welcome to zkdex, this is a private key seed a".as_bytes()).unwrap();
/// let private_key_b = private_key_from_seed("welcome to zkdex, this is a private key seed b".as_bytes()).unwrap();
/// let sig = zkdex_sdk::unified::unified_sign_perpetual_trade(json, &private_key_a, &private_key_b);
/// assert!(sig.is_ok());
/// ```
...
/// }
///         "##;
/// let hash = zkdex_sdk::unified::unified_hash_perpetual_trade(json);
/// assert!(hash.is_ok());
/// ```
...
///         "##;
/// let private_key = private_key_from_seed("welcome to zkdex, this is a private key seed".as_bytes()).unwrap();
/// let sig = zkdex_sdk::unified::unified_sign_transfer(json, &private_key);
/// assert!(sig.is_ok());
/// ```
...
///         }
///         "##;
/// let hash = zkdex_sdk::unified::unified_hash_transfer(json);
/// assert!(hash.is_ok());
/// ```
...
///         "##;
/// let private_key = private_key_from_seed("welcome to zkdex, this is a private key seed".as_bytes()).unwrap();
/// let sig = zkdex_sdk::unified::unified_sign_oracle_price(json, &private_key);
/// assert!(sig.is_ok());
/// ```
...
///             }
///         "##;
/// let hash = zkdex_sdk::unified::unified_hash_oracle_price(json);
/// assert!(hash.is_ok());
/// ```
...
/// # Examples
/// ```
/// use zkdex_sdk::private_key_from_seed;let json = r##"
/// {
...
///         "##;
/// let private_key = private_key_from_seed("welcome to zkdex, this is a private key seed".as_bytes()).unwrap();
/// let sig = zkdex_sdk::unified::unified_sign_liquidate(json, &private_key);
/// assert!(sig.is_ok());
/// ```
...
/// }
///         "##;
/// let hash = zkdex_sdk::unified::unified_hash_liquidate(json);
/// assert!(hash.is_ok());
/// ```
...
///         "#;
/// let private_key = private_key_from_seed("welcome to zkdex, this is a private key seed".as_bytes()).unwrap();
/// let sig = zkdex_sdk::unified::unified_sign_spot_limit_order(json,&private_key);
/// assert!(sig.is_ok());
/// ```
...
///         }
///         "#;
/// let hash = zkdex_sdk::unified::unified_hash_spot_limit_order(json);
/// assert!(hash.is_ok());
/// ```
...
///         "#;
/// let private_key = private_key_from_seed("welcome to zkdex, this is a private key seed".as_bytes()).unwrap();
/// let sig = zkdex_sdk::unified::unified_sign_perpetual_limit_order(json, &private_key);
/// assert!(sig.is_ok());
/// ```
...
///         }
///         "#;
/// let sig = zkdex_sdk::unified::unified_hash_perpetual_limit_order(json);
/// assert!(sig.is_ok());
/// ```
