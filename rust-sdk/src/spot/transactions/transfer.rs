...
pub fn transfer_hash(transfer: &Transfer) -> HashType {
    ...
    hasher.update_single(&(transfer.asset_id as u64));
    hasher.update_single(&0u64);

    let mut packed_message0 = U256([
        transfer.sender_position_id as u64,
        transfer.receiver_position_id as u64,
        transfer.sender_position_id as u64,
        0,
    ]);
