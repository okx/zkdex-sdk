...
wasm-pack build --features js --release --target=bundler --out-name=zkdex-bundler --out-dir=dist
# pack for browser
wasm-pack build --features js --release --target=web --out-name=zkdex-web --out-dir=web-dist
# pack for node.js
wasm-pack build --features js --release --target=nodejs --out-name=zkdex-node --out-dir=node-dist
